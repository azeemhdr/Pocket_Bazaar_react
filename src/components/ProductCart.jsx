...
export default function ProductCart() {
  return (
	<>
	<button className='bg-[#009f7f] flex flex-col px-3 pb-3 pt-3.5 rounded-ss rounded-es  fixed top-1/2 right-0 z-40 cursor-pointer'>
		...
		<span className='w-full p-2 mt-3 rounded bg-[#ffffff] text-[#009f7f] text-sm font-semibold'>&#8377;0.00</span>
