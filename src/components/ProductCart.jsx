...
export default function ProductCart() {
  ...
  return (
    <>
      <button
        className="bg-[#009f7f] flex flex-col px-3 pb-3 pt-3.5 rounded-ss rounded-es  fixed top-1/2 right-0 z-40 cursor-pointer hover:bg-[#019376] transition"
        onClick={openCart}
      >
            ...
            <div className="cart-wrapper h-full w-screen max-w-md">
              <section className="flex items-center flex-col h-full">
                <div className="cart-header  font-semibold flex items-center justify-between max-w-md  w-full px-6 py-4 border-b-1 border-gray-200">
                  ...
                  <button
                    className="bg-[#f3f4f6] hover:bg-[#009f7f] transition cursor-pointer h-7 w-7 flex items-center justify-center rounded-full text-gray-500 hover:text-[#f2f2f2]"
                    onClick={cartClose}
                  >
                    <svg
                      className="h-3 w-3"
                ...
                <div className="cart-footer px-6 py-5 w-full ">
                  <button className="font-semibold bg-[#009f7f] flex justify-between items-center w-full h-12 md:h-14 rounded-full p-1 hover:bg-[#019376] transition cursor-pointer">
                    <span className="px-5 flex flex-1 items-center h-full text-white">
                      Checkout
                    </span>
                    <span className="bg-[#f2f2f2] flex h-full items-center rounded-full px-5 text-[#009f7f]">
                      &#8377;0.00
                    </span>
                  </button>
                </div>
