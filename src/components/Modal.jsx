...
export default function Modal() {
  ...
  return (
	<>
	{isModal && (
		<div className='fixed inset-0 bg-[#8e939a47] flex items-center justify-center z-60'>
				...
				<div className='modal-content md:p-12 w-1/2'>
					...
					<div className='flex'>
						<form action="" className='w-full'>
							<div className='border border-gray-200 w-full flex items-center rounded'>
								<input type="text" name='email' className='h-14 w-full text-sm border-0 bg-trasnparent text-xs py-2 ps-5 pe-3 focus:outline-1 focus:outline-[#009f7f] rounded-ss rounded-es' placeholder='Write your email here'/>
